...
PKGNAME=php-tc-lib-pdf-filter

# Default installation path for code
LIBPATH=usr/share/php/Com/Tecnick/Pdf/Filter/
...
help:
	@echo ""
	@echo "Welcome to tc-lib-pdf-filter make."
...
docs:
	@rm -rf target/phpdocs && ./vendor/phpdocumentor/phpdocumentor/bin/phpdoc project:run --target="target/phpdocs/" --directory="src/" --ignore="vendor/" --encoding="UTF-8" --title="tc-lib-pdf-filter" --parseprivate
